...
**只有远程更高才提示更新**（相等或更低忽略，禁止降级）。发现新版本后不会弹出对话框，顶部工具栏“关联掘金”左侧显示“下载并更新”按钮；用户也可在设置的“应用更新”区域操作或跳过此版本。跳过记录会保留到
出现后续版本，手动检查更新则可重新选择。点击“下载并更新”后会在顶部按钮原位和设置中展示下载进度，下载完成即自动停止本地 runtime、放开
