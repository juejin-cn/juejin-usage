...
const tudApi = {
  ...
  downloadAndInstallUpdate: (): Promise<AutoUpdateState> =>
    ipcRenderer.invoke(AUTO_UPDATE_START_CHANNEL),

  skipUpdate: (): Promise<AutoUpdateState> =>
    ipcRenderer.invoke(AUTO_UPDATE_SKIP_CHANNEL),
